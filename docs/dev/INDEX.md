...
- [发布运维](RELEASES.md)：发布附件与 updater 元数据规则。
- [发布元数据规范化](modules/release-metadata.md)：将 updater URL 转换为公开下载地址的脚本和工作流契约。
- [发布收尾器](modules/release-finalizer.md)：草稿校验、校验和、发布说明、正式发布和失败恢复。

const translations = {
    "zh": {
        ...
        "btn_browse": "浏览...",
        "btn_check_api_sources": "检测",
        "label_format": "文件格式",
        "btn_start_download": " 开始下载",
        "btn_add_to_queue": " 加入待下载",
        "btn_cancel_download": " 取消下载",
        "btn_reset": "重置",
        "btn_confirm_add_to_queue": "加入队列",

        // API Sources
        "api_auto_select": "自动选择（推荐）",
        "api_checking_sources": "正在检测接口可用性...",
        "api_check_failed": "检测失败：{0}",
        "api_select_failed": "切换接口失败",
        "api_available_latency": "可用 {0}ms",
        "api_unavailable": "不可用",
        "api_status_no_current": "当前未选择下载接口",
        "api_status_auto": "自动：{0} · 可用（{1}ms）",
        "api_status_manual": "手动：{0} · 可用（{1}ms）",
        "api_status_auto_bad": "自动：{0} · 不可用",
        "api_status_manual_bad": "手动：{0} · 不可用",

        // Queue Pane
        "queue_summary": "待下载：0 本",
        "queue_summary_count": "待下载：{0} 本",
        "queue_empty": "暂无待下载任务",
        "queue_unknown_book": "未知书籍",
        "btn_start_queue_download": "一键下载",
        ...
        "update_progress_title": "正在下载更新...",
        "update_status_connecting": "正在连接...",
        "update_warn_dont_close": "请勿关闭此窗口",
        "update_btn_install": "安装并重启",
    ...
    "en": {
        ...
        "btn_browse": "Browse...",
        "btn_check_api_sources": "Check",
        "label_format": "Format",
        "btn_start_download": " Download",
        "btn_add_to_queue": " Add to Queue",
        "btn_cancel_download": " Cancel",
        "btn_reset": "Reset",
        "btn_confirm_add_to_queue": "Add",

        // API Sources
        "api_auto_select": "Auto (recommended)",
        "api_checking_sources": "Checking endpoints...",
        "api_check_failed": "Check failed: {0}",
        "api_select_failed": "Failed to switch endpoint",
        "api_available_latency": "OK {0}ms",
        "api_unavailable": "Unavailable",
        "api_status_no_current": "No endpoint selected",
        "api_status_auto": "Auto: {0} · OK ({1}ms)",
        "api_status_manual": "Manual: {0} · OK ({1}ms)",
        "api_status_auto_bad": "Auto: {0} · Unavailable",
        "api_status_manual_bad": "Manual: {0} · Unavailable",

        // Queue Pane
        "queue_summary": "Queue: 0 books",
        "queue_summary_count": "Queue: {0} books",
        "queue_empty": "No pending downloads",
        "queue_unknown_book": "Unknown Book",
        "btn_start_queue_download": "Start Download",
        ...
        "title_confirm_download": "Add to Queue",
        "label_author": "Author: ",
        "text_author": "Author: ",
        ...
        "update_warn_dont_close": "Please do not close this window",
